  ...
  <form @submit.prevent="onSubmit" class="screen">
    <div class="container">
      ...
      <div class="row">
        <div class="col-7">
          <div class="section">
            <p>We like being on a first-name basis, but it also helps us get in touch with you.</p>
            <div class="form-group">
              <div class="form-item col">
                ...
                <p v-if="error.status" class="error-text">{{ error.text }}</p>
                <p v-if="success.status" class="success-text">
                  {{ success.text }}
                </p>
              </div>
              <div class="form-item col">
          ...
          <div class="section options">
            ...
            <div class="row">
              <div class="col-4" v-for="option in jobOption" :key="option.id">
                <div
                  class="block"
                  :style="{
                    backgroundColor: quiz.jobs.includes(option.id) ? 'var(--primary)' : '',
                  }">
                  <label class="option">
        ...
        <div class="col-4">
          <div class="section right">
            <p>
              Tell us what you need help with, the purpose of this project and problems wr’re
              solving.
            </p>
            <div class="form-item">
              ...
              <ul class="items">
                <li class="item">
                  <div class="file">
                    ...
                    <div class="file-name">website-information-architecture.pdf</div>
                    <div class="file-icon">
...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      } else if (this.quiz.fullName.length >= 6 && this.quiz.fullName.length <= 18) {
        this.success = {
          text: 'Look great',
          status: true,
        };
